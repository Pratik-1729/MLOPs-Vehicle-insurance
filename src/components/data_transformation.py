...
class DataTransformation:
    ...
    def get_data_transformer_object(self)-> Pipeline:
        ...
        try:
            ...
            logging.exception("Exception occurred in get_data_transformer_object method of DataTransformer Class")
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        ...
        try:
            ...
            # APPLY CUSTOM TRANSFORMERS IN SPECIFIED SEQUENCE
            ...
            logging.info("starting data transformation for training data")
